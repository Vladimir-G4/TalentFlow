    ...
    >
      ...
      <div className="p-5 z-10 flex space-x-4">
        <div className="w-1/3 bg-white bg-opacity-70 rounded-lg shadow-lg p-10 text-center">
          ...
          <button className="mt-4 flex items-center justify-center bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 transition">
      ...
      <div className="absolute top-5 right-5">
        <nav className="flex space-x-4">
          <a href="/" className="font-poppins text-white hover:text-blue-500 transition">Home</a>
